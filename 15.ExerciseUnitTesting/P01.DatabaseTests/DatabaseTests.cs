namespace Database.Tests
{
    ...
    public class DatabaseTests
    {
        ...
        [Test]
        public void CountMustReturnZeroWheNoElements()
        {
            int actialCount = this.db.Count;
            int expectedCount = 0;
        ...
        public void RemoveShouldRemoveTheLastElementMoreThanOnce()
        {
            ...
            int[] actualData = this.db.Fetch();
            int[] expectectedData = new int[] { };

            int actualCount = this.db.Count;
            int expectedCount = 0;

            CollectionAssert.AreEqual(expectectedData, actualData,
                "Remove should physically remove the element in the data field!");
        ...
        [Test]
        public void RemoveShouldThrowsErrorWhenThereAreNoElements()
        {
            Assert.Throws<InvalidOperationException>(() =>
            {
                this.db.Remove();
